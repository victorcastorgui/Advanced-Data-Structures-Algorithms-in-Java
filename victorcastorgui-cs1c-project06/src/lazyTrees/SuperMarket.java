...
public class SuperMarket 
{
	...
	//private static final int GARBAGE_COLLECTION_THRESHOLD = 3;
	...
	public static void main(String[] args) 
	{
		...
		// NOTE: Tests when threshold is changed to 2
		//final String TESTFILE = "resources/inventory_threshold.txt";

		// NOTE: Tests when threshold is changed to 3
		//final String TESTFILE = "resources/inventory_threshold2.txt";

		// NOTE: Tests when remove all
		//final String TESTFILE = "resources/inventory_remove_all.txt";
