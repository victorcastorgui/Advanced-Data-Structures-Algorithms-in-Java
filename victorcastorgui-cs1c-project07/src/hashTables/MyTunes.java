 ...
 *
 * @author Foothill College, Bita M [VICTOR CASTOR]
 */
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		final String TESTFILE01 = "resources/invalidIDs.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/findGenres.txt"; // Example test file for hashing based on genres names
		//final String TESTFILE02 = "resources/AllGenres.txt"; // Example test file for hashing based on genres names
		final String TESTFILE02 = "resources/invalidGenres.txt"; // Example test file for hashing based on genres names
